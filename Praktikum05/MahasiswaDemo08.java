...
public class MahasiswaDemo08 {
    public static void main(String[] args) {
        ...
        System.out.println("Data Mahasiswa setelah sortingberdasarkan IPK (DESC): ");
        list.bubbleSort();
        list.tampil();

        System.out.println("Data yang sudah diurutkan Selection Sort (ASC): ");
        list.selectionSort();
        list.tampil();

        System.out.println("Data yang sudah diurutkan Insertion Sort (ASC): ");
        list.insertionSort();
        list.tampil();
